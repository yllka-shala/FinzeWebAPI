...
namespace FinanceAPI.Controllers
{
    ...
    public class RecurringController : ControllerBase
    {
        ...
        [HttpPost("Create")]
        public async Task<IActionResult> Create(RecurringDTO create)
        {
        ...
        [HttpPut("Update/{id}")]
        public async Task<IActionResult> Update(RecurringDTO update, int id)
        {
        ...
        {
            var response = await _service.GetFrequencies();
        ...
        public async Task<IActionResult> ExportData(string format)
        {
            ...
            if (format.ToLower() == "excel")
            {
                ...
                var fileName = $"RecurringReport_{DateTime.Now:dd-MM-yyyy}.xlsx";
            ...
            else
            {
                ...
                var fileName = $"RecurringReport_{DateTime.Now:dd-MM-yyyy}.pdf";
