...
namespace FinanceAPI.Controllers
{
    ...
    public class BudgetController : ControllerBase
    {
        ...
        [HttpPost("Create")]
        public async Task<IActionResult> Create(BudgetDTO create)
        {
        ...
        [HttpPut("Update/{id}")]
        public async Task<IActionResult> Update(int id, BudgetDTO update)
        {
        ...
        public async Task<IActionResult> ExportData(string format)
        {
            ...
            else
            {
                ...
                var fileName = $"BudgetReport_{DateTime.Now:dd-MM-yyyy}.pdf";
