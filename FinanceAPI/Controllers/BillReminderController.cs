...
namespace FinanceAPI.Controllers
{
    ...
    [ApiController]
    [Authorize]
    public class BillReminderController : ControllerBase
    {
        private readonly IBillReminderService _service;

        public BillReminderController(IBillReminderService service)
        {
            _service = service;
        }
        ...
        [HttpPost("Create")]
        public async Task<IActionResult> Create(BillReminderDTO create)
        {
        ...
        [HttpPut("Update/{id}")]
        public async Task<IActionResult> Update(BillReminderDTO update, int id)
        {
        ...
        public async Task<IActionResult> ExportData(string format)
        {
            ...
            if (format.ToLower() == "excel")
            {
                ...
                var fileName = $"BillReminderReport_{DateTime.Now:dd-MM-yyyy}.xlsx";
            ...
            else
            {
                ...
                var fileName = $"BillReminderReport_{DateTime.Now:dd-MM-yyyy}.pdf";
